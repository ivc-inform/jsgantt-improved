    ...
    def get() = {
        ...
        g.getDivId.foreach {
            _ ⇒
                ...
                g.AddTaskItem(new TaskItemExt(pID = 1, pName = "Define Chart API", pClass = "ggroupblack", pLink = "", pMile = 0, pRes = "Brian", pComp = 0, pGroup = 1, pParent = 0, pOpen = 1, pDepend = "", pCaption = "", pNotes = "Some Notes text", pGantt = g))
